...
import com.example.trackly.notification.NotificationManager as TracklyNotificationManager
...
class SetBudgetActivity : AppCompatActivity() {
    ...
    private lateinit var notificationManager: TracklyNotificationManager
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        notificationManager = TracklyNotificationManager(this)
